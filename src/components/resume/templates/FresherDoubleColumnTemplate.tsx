...
interface FresherDoubleColumnTemplateProps {
...
export const FresherDoubleColumnTemplate = ({
  resumeData,
  themeColor = "#10b981",
  editable = false,
}: FresherDoubleColumnTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      ...
      <div className="grid grid-cols-2 gap-8">
        {/* Left Column */}
        <div className="border-r-2 pr-8" style={{ borderColor: withOpacity(accent, "30") }}>
          {/* Education */}
          {resumeData.education && resumeData.education.length > 0 && (
            <div className="mb-8">
              <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider pb-2 border-b-2" style={{ color: accent, borderColor: withOpacity(accent, "40") }}>
                Education
              </h2>
              {resumeData.education.map((edu, index) => (
                <div key={edu.id} className="mb-5 last:mb-0">
                  ...
                  />
                  <div className="text-[12px] text-gray-600 flex items-center gap-2 flex-wrap">
                    <InlineEditableDate
        ...
        <div>
          ...
          {resumeData.personalInfo.summary && (
            <div className="mb-8">
              <h2 className="text-[16px] font-bold mb-3 uppercase tracking-wider pb-2 border-b-2" style={{ color: accent, borderColor: withOpacity(accent, "40") }}>
                Summary
              </h2>
              <InlineEditableText
