...
interface NewspaperStyleUniversalTemplateProps {
...
export const NewspaperStyleUniversalTemplate = ({
  resumeData,
  themeColor = "#0f766e",
  editable = false,
}: NewspaperStyleUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#0f766e";
