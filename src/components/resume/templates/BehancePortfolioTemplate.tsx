...
interface BehancePortfolioTemplateProps {
...
export const BehancePortfolioTemplate = ({
  resumeData,
  themeColor = "#1769ff",
  editable = false,
}: BehancePortfolioTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#1769ff";
  const accentLight = withOpacity(accent, "15") ?? "#1769ff15";
  const accentBorder = withOpacity(accent, "33") ?? "#1769ff33";
