...
export const MedicalProfessionalTemplate = ({
  resumeData,
  themeColor = "#0066cc",
  editable = false,
  ...
  return (
    <div className="mx-auto bg-white p-12 font-sans text-gray-900">
      {/* Header Section */}
      <div className="mb-6 flex items-start justify-between border-b-4 pb-4" style={{ borderColor: themeColor }}>
