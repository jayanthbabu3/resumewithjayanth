        ...
        {personalInfo.title && (
          editable ? (
            <InlineEditableText
              ...
              className="text-2xl text-gray-600 mb-4 font-light block"
              as="h2"
            />
          ) : (
            <h2 className="text-2xl text-gray-600 mb-4 font-light">
              {personalInfo.title}
            </h2>
          )
        )}
                ...
                <div className="mb-6 last:mb-0">
                  ...
                  {exp.description && (
                    <InlineEditableText
                      ...
                      className="text-sm text-gray-700 whitespace-pre-line block"
                      multiline
                      as="p"
                    />
                  )}
          ...
          <div>
            ...
            {editable ? (
              ...
              <div className="grid grid-cols-2 gap-3">
                {skills.map((skill) =>
                  skill.name ? (
                    <div key={skill.id} className="px-3 py-2 rounded text-sm font-medium text-center" style={{ backgroundColor: `${themeColor}15`, color: themeColor }}>
                      {skill.name}
                    </div>
                  ) : null
                )}
              ...
              <div className="space-y-4">
                {education.map((edu) => (
                  <div key={edu.id} className="mb-4 last:mb-0">
                    ...
                    <p className="text-gray-600 italic">{edu.school || "School Name"}</p>
...
export default ArtisticMomentumTemplate;
