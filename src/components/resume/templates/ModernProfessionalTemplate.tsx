...
export const ModernProfessionalTemplate = ({ resumeData, themeColor = "#0891b2", editable = false, onAddBulletPoint, onRemoveBulletPoint }: TemplateProps) => {
  ...
  return (
    <div className="w-full bg-white text-gray-900 p-8 text-[13px] leading-relaxed">
          ...
          {editable ? (
            <InlineEditableList
              ...
              renderItem={(exp, index) => (
                <div className="mb-6 p-4 rounded-lg group" style={{ backgroundColor: `${themeColor}05` }}>
            ...
            <div className="space-y-6">
              {resumeData.experience.map((exp) => (
                <div key={exp.id} className="p-4 rounded-lg group" style={{ backgroundColor: `${themeColor}05` }}>
                  <div className="flex justify-between items-start mb-2 gap-4">
                    <div className="flex-1">
      ...
      {/* Custom Sections */}
      <ModernProfessionalCustomSections 
...
const ModernProfessionalCustomSections = ({ 
  sections, 
  editable, 
  themeColor 
}: { 
