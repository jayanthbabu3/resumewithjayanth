...
interface TiktokContentCreatorTemplateProps {
...
export const TiktokContentCreatorTemplate = ({
  resumeData,
  themeColor = "#000000",
  editable = false,
}: TiktokContentCreatorTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#000000";
  const accentLight = withOpacity(accent, "15") ?? "#00000015";
  const accentBorder = withOpacity(accent, "33") ?? "#00000033";
