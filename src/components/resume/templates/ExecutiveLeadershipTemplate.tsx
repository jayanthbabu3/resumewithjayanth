...
interface ExecutiveLeadershipTemplateProps {
...
export const ExecutiveLeadershipTemplate = ({
  resumeData,
  themeColor = "#8b5cf6",
  editable = false,
}: ExecutiveLeadershipTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-3 uppercase tracking-wider" style={{ color: accent }}>Executive Profile</h2>
      ...
      {resumeData.experience && resumeData.experience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Leadership Experience</h2>
      ...
      {resumeData.education && resumeData.education.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Education & Executive Development</h2>
      ...
      {resumeData.skills && resumeData.skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Strategic Competencies</h2>
