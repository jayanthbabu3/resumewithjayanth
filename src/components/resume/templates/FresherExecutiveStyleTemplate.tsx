...
export const FresherExecutiveStyleTemplate = ({ resumeData, themeColor = "#7c3aed", editable = false }: TemplateProps) => {
  ...
  return (
    <div className="w-full bg-white text-gray-900 p-8" style={{ fontFamily: 'Inter' }}>
      {/* Bold Header Section */}
      <div className="mb-8 p-8 rounded-lg" style={{ backgroundColor: themeColor }}>
          ...
          <div className="flex-1">
            {editable ? (
              <InlineEditableText
                ...
                className="text-[40px] font-bold mb-2 text-white block"
                as="h1"
              />
            ) : (
              <h1 className="text-[40px] font-bold mb-2 text-white">
            ...
            {editable ? (
              <InlineEditableText
                ...
                className="text-[16px] text-white/90 font-medium block"
                as="p"
              />
            ) : (
            ...
            <div className="flex gap-6 mt-4 text-[12.5px] text-white/80">
                ...
                <InlineEditableSkills
                  ...
                  renderSkill={(skill) => (
                    <div className="mb-2 flex items-center">
                      ...
                      <span className="text-[13px] text-gray-800 font-medium">{skill.name}</span>
                    </div>
                  )}
                />
              ) : (
