...
interface MinimalLinesUniversalTemplateProps {
...
export const MinimalLinesUniversalTemplate = ({
  resumeData,
  themeColor = "#4338ca",
  editable = false,
}: MinimalLinesUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#4338ca";
