...
export const FresherEliteTemplate = ({
  ...
  return (
    <div className="w-full h-full bg-gray-50 p-10">
      <div className="max-w-[900px] mx-auto bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1 text-white">
              ...
              {resumeData.personalInfo.title && (
                <p className="text-lg font-medium mb-4 opacity-95">
                  {resumeData.personalInfo.title}
                </p>
              )}
        ...
        <div className="px-12 py-8">
          ...
          {resumeData.personalInfo.summary && (
            <div className="mb-8">
              <div className="bg-gray-50 rounded-xl p-6 border-l-4" style={{ borderColor: themeColor }}>
                  ...
                  <div className="space-y-4">
                    {resumeData.education.map((edu, index) => (
                      <div key={index} className="bg-white rounded-lg p-4 border border-gray-200">
                        ...
                        {edu.field && (
                          <p className="text-xs text-gray-600 mb-2">{edu.field}</p>
                        )}
