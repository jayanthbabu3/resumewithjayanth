...
interface AdobePortfolioDesignerTemplateProps {
...
export const AdobePortfolioDesignerTemplate = ({
  resumeData,
  themeColor = "#ff0000",
  editable = false,
}: AdobePortfolioDesignerTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#ff0000";
  const accentLight = withOpacity(accent, "15") ?? "#ff000015";
  const accentBorder = withOpacity(accent, "33") ?? "#ff000033";
