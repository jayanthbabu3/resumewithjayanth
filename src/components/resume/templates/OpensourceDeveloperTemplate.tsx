...
interface OpensourceDeveloperTemplateProps {
...
export const OpensourceDeveloperTemplate = ({
  resumeData,
  themeColor = "#0969da",
  editable = false,
}: OpensourceDeveloperTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#0969da";
  const accentLight = withOpacity(accent, "15") ?? "#0969da15";
  const accentBorder = withOpacity(accent, "33") ?? "#0969da33";
