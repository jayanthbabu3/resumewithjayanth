...
interface SketchExpertPortfolioTemplateProps {
...
export const SketchExpertPortfolioTemplate = ({
  resumeData,
  themeColor = "#f7b500",
  editable = false,
}: SketchExpertPortfolioTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#f7b500";
  const accentLight = withOpacity(accent, "15") ?? "#f7b50015";
  const accentBorder = withOpacity(accent, "33") ?? "#f7b50033";
