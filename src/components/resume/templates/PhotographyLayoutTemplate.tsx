...
interface PhotographyLayoutTemplateProps {
...
export const PhotographyLayoutTemplate = ({
  resumeData,
  themeColor = "#ec4899",
  editable = false,
}: PhotographyLayoutTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      <div className="mb-8">
        ...
        <InlineEditableText text={resumeData.personalInfo.title} className="text-[18px] text-gray-700 mb-4 font-medium" editable={editable} field="resumeData.personalInfo.title" />
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-[18px] font-bold mb-3" style={{ color: accent }}>About</h2>
      ...
      {resumeData.experience && resumeData.experience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[18px] font-bold mb-4" style={{ color: accent }}>Experience</h2>
      ...
      {resumeData.education && resumeData.education.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[18px] font-bold mb-4" style={{ color: accent }}>Education</h2>
      ...
      {resumeData.skills && resumeData.skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[18px] font-bold mb-4" style={{ color: accent }}>Skills</h2>
      ...
      {resumeData.sections && resumeData.sections.map((section, sectionIndex) => (
        <div key={section.id} className="mb-8 last:mb-0">
          <h2 className="text-[18px] font-bold mb-4" style={{ color: accent }}>
