...
interface StripedBackgroundUniversalTemplateProps {
...
export const StripedBackgroundUniversalTemplate = ({
  resumeData,
  themeColor = "#ca8a04",
  editable = false,
}: StripedBackgroundUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#ca8a04";
