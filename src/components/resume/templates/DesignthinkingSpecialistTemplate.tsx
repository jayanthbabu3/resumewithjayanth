...
interface DesignthinkingSpecialistTemplateProps {
...
export const DesignthinkingSpecialistTemplate = ({
  resumeData,
  themeColor = "#f59e0b",
  editable = false,
}: DesignthinkingSpecialistTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#f59e0b";
  const accentLight = withOpacity(accent, "15") ?? "#f59e0b15";
  const accentBorder = withOpacity(accent, "33") ?? "#f59e0b33";
