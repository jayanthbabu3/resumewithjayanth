...
interface LeetcodeChampionTemplateProps {
...
export const LeetcodeChampionTemplate = ({
  resumeData,
  themeColor = "#ffa116",
  editable = false,
}: LeetcodeChampionTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#ffa116";
  const accentLight = withOpacity(accent, "15") ?? "#ffa11615";
  const accentBorder = withOpacity(accent, "33") ?? "#ffa11633";
