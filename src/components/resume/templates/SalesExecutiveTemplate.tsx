...
interface SalesExecutiveTemplateProps {
  resumeData: ResumeData;
  themeColor?: string;
  editable?: boolean;
}

export const SalesExecutiveTemplate = ({
  resumeData,
  themeColor = "#d84315",
  editable = false,
  ...
  return (
    <div className="mx-auto bg-white p-12 font-sans text-gray-900">
      <div className="mb-6 border-b-4 pb-4" style={{ borderColor: themeColor }}>
        {editable ? (
          <InlineEditableText
          ...
          {editable ? (
            <InlineEditableList
              ...
              defaultItem={{
                ...
                startDate: "2023-01",
                endDate: "2024-01",
                description: "Generated $X million in new revenue, exceeding quota by X%\nBuilt and managed sales pipeline worth $X million\nClosed X new enterprise accounts with average deal size of $X\nAchieved X% customer retention through relationship management",
                current: false,
              }}
                  ...
                  <div className="flex items-baseline justify-between mb-1">
                    <h4 className="font-bold text-lg text-gray-900">
                      <InlineEditableText
                        ...
                        value={exp.position}
                        className="font-bold text-lg text-gray-900 inline"
                        as="span"
                      />
                    </h4>
