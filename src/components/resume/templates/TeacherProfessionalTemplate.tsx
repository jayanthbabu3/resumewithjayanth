...
interface TeacherProfessionalTemplateProps {
  resumeData: ResumeData;
  themeColor?: string;
  editable?: boolean;
}

export const TeacherProfessionalTemplate = ({
  resumeData,
  themeColor = "#0d47a1",
  editable = false,
      ...
      {editable ? (
        <InlineEditableList
          ...
          defaultItem={{
            ...
            content: "State Teaching License - Grade Levels K-8\nESL Endorsement\nGoogle Certified Educator Level 1",
          }}
          ...
          {editable ? (
            <InlineEditableList
              ...
              defaultItem={{
                ...
                startDate: "2023-01",
                endDate: "2024-01",
                description: "Developed and implemented engaging lesson plans for X students\nImproved student test scores by X% through differentiated instruction\nCollaborated with parents and staff to support student success\nIntegrated technology to enhance learning outcomes",
                current: false,
              }}
