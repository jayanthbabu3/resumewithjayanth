...
export const BusinessEliteTemplate = ({ resumeData, themeColor = "#854d0e", editable = false }: TemplateProps) => {
          ...
          {editable ? (
            <InlineEditableList
              ...
              renderItem={(exp, index) => (
                <div className="mb-6 pb-6" style={{ borderBottom: `1px solid ${themeColor}20` }}>
            ...
            <div className="space-y-0">
              {resumeData.experience.map((exp, idx) => (
                <div key={exp.id} className="mb-6 pb-6" style={{ borderBottom: idx < resumeData.experience.length - 1 ? `1px solid ${themeColor}20` : 'none' }}>
                  <div className="flex justify-between items-start mb-2 gap-4">
                    <div className="flex-1">
