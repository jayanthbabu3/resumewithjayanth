...
export const BusinessEliteTemplate = ({ resumeData, themeColor = "#854d0e", editable = false, onAddBulletPoint, onRemoveBulletPoint }: TemplateProps) => {
  ...
  return (
    <div className="w-full bg-white text-gray-900 p-8 text-[13px] leading-relaxed">
      {/* Header - Elite */}
      <div className="mb-8 p-6" style={{ backgroundColor: `${themeColor}10`, borderLeft: `4px solid ${themeColor}` }}>
        {editable ? (
          <InlineEditableText
        ...
        {editable ? (
          <InlineEditableText
            ...
            className="text-[15px] text-gray-700 mb-4 font-semibold block"
            as="p"
          />
        ) : (
          <p className="text-[15px] text-gray-700 mb-4 font-semibold">
          ...
          {editable ? (
            <InlineEditableList
              ...
              renderItem={(exp, index) => (
                <div className="mb-6 pb-6 group" style={{ borderBottom: `1px solid ${themeColor}20` }}>
            ...
            <div className="space-y-0">
              {resumeData.experience.map((exp, idx) => (
                <div key={exp.id} className="mb-6 pb-6 group" style={{ borderBottom: idx < resumeData.experience.length - 1 ? `1px solid ${themeColor}20` : 'none' }}>
                  <div className="flex justify-between items-start mb-2 gap-4">
                    <div className="flex-1">
...
const BusinessEliteCustomSections = ({ sections, editable, themeColor }: { sections: ResumeData['sections']; editable: boolean; themeColor?: string; }) => {
    ...
    <>
      {sections && sections.map((section, index) => (
        <div key={section.id} className="mb-8 group/section" style={{ pageBreakInside: 'avoid' }}>
          <div className="flex items-center gap-2">
            <h2 className="text-[15px] font-bold mb-4 uppercase tracking-wider flex-1" style={{ color: themeColor }}>
