...
export const SeniorMobileEngineerTemplate = ({ resumeData, themeColor = "#3DDC84", editable = false }: TemplateProps) => {
  ...
  return (
    <div className="w-full min-h-[297mm] bg-white font-['Inter',sans-serif] text-gray-900">
      ...
      <div className="bg-gradient-to-br from-green-50 to-white border-b-4" style={{ borderColor: accent }}>
          ...
          <div className="flex items-start justify-between gap-8">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 mb-4 rounded-lg border-2" style={{ borderColor: accent, backgroundColor: accentLight }}>
                ...
                <span className="text-[11px] font-bold uppercase tracking-wider" style={{ color: accent }}>Senior Mobile Engineer</span>
              </div>
              ...
              <p className="text-[16px] font-semibold mb-5" style={{ color: accent }}>
                {editable ? (
                  <InlineEditableText
                    ...
                    placeholder="iOS & Android Expert | Mobile Architecture Lead"
                    as="span"
                  />
                ) : (
      ...
      <div className="max-w-4xl mx-auto px-12 py-10">
        ...
        {(resumeData.personalInfo.summary || editable) && (
          <div className="mb-10">
            <h2 className="text-[15px] font-bold mb-4 text-gray-900 uppercase tracking-wider pb-2 border-b-2" style={{ borderColor: accent }}>
              Professional Summary
            </h2>
            <p className="text-[13.5px] text-gray-700 leading-[1.8]">
              {editable ? (
                <InlineEditableText
                  ...
                  placeholder="Senior Mobile Engineer with 10+ years building iOS and Android applications for millions of users. Expert in Swift, Kotlin, and cross-platform development. Led mobile architecture initiatives improving app performance by 60% and reducing crash rates to < 0.1%. Passionate about creating delightful mobile experiences and mentoring mobile developers..."
                  multiline
                  as="span"
                />
              ) : (
        ...
        {((resumeData.experience && resumeData.experience.length > 0) || editable) && (
          <div className="mb-10">
            <h2 className="text-[15px] font-bold mb-5 text-gray-900 uppercase tracking-wider pb-2 border-b-2" style={{ borderColor: accent }}>
              Professional Experience
            </h2>
            {editable ? (
              <InlineEditableList
                ...
                defaultItem={{
                  ...
                  current: false,
                  description: "• Built iOS app with 5M+ downloads and 4.8+ star rating\n• Improved app performance reducing launch time by 70%\n• Led team of 6 mobile engineers in implementing new architecture",
                  id: Date.now().toString(),
                }}
                renderItem={(exp, index) => (
                  <div className="mb-7 last:mb-0 bg-white rounded-xl p-5 border-2" style={{ borderColor: accentBorder }}>
                    <div className="flex justify-between items-start mb-2.5">
                      ...
                      <div className="text-[11.5px] font-semibold whitespace-nowrap ml-4 px-3 py-1.5 rounded-full" style={{ backgroundColor: accent, color: "white" }}>
                        <InlineEditableDate
                    ...
                    <div className="text-[13px] text-gray-700 leading-[1.8] whitespace-pre-wrap">
                      <InlineEditableText
                        ...
                        placeholder="• Mobile app achievement with user impact\n• Performance improvement with metrics\n• Team leadership accomplishment"
                        multiline
                        as="div"
                      />
                    </div>
              ...
              resumeData.experience.map((exp, index) => (
                <div key={index} className="mb-7 last:mb-0 bg-white rounded-xl p-5 border-2" style={{ borderColor: accentBorder }}>
                  <div className="flex justify-between items-start mb-2.5">
                    <div className="flex-1">
        ...
        {editable ? (
          <InlineEditableList
            ...
            defaultItem={{
              title: "App Portfolio",
              content: "Published iOS apps with 10M+ combined downloads\nGoogle Play featured developer (2023)\nApp Store 'App of the Day' recognition",
              id: Date.now().toString(),
            }}
