...
export const GoDeveloperTemplate = ({ resumeData, themeColor = "#00ADD8", editable = false }: TemplateProps) => {
  const photo = resumeData.personalInfo.photo;
  const accent = normalizeHex(themeColor) ?? "#00ADD8";
  ...
  return (
    <div className="w-full min-h-[297mm] bg-white font-['Inter',sans-serif] text-gray-900">
      {/* Header - Go-inspired minimalist design */}
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-12 pt-10 pb-8">
          <div className="flex items-start justify-between gap-6">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                <div className="text-[24px] font-bold" style={{ color: accent }}>Go</div>
                <div className="flex-1 h-px" style={{ backgroundColor: accentMedium }} />
              </div>
      ...
      <div className="max-w-4xl mx-auto px-12 py-8">
        ...
        {(resumeData.personalInfo.summary || editable) && (
          <div className="mb-8">
            <h2 className="text-[14px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>
              // Professional Summary
            </h2>
            <p className="text-[13px] text-gray-700 leading-[1.8]">
              {editable ? (
                <InlineEditableText
                  ...
                  placeholder="Go Developer with 5+ years building high-performance backend services and distributed systems. Expert in Go concurrency patterns, microservices architecture, and cloud-native development..."
                  multiline
                  as="span"
                />
              ) : (
            ...
            {editable ? (
              <InlineEditableList
                ...
                defaultItem={{
                  ...
                  current: false,
                  description: "• Developed high-performance microservices using Go handling 100K+ requests/second\n• Implemented concurrent processing patterns using goroutines and channels\n• Built RESTful and gRPC APIs for distributed systems\n• Optimized database queries and reduced latency by 65%",
                ...
                renderItem={(exp, index) => (
                  <div className="mb-6 last:mb-0">
                    ...
                    <div className="text-[12.5px] text-gray-700 leading-[1.8] whitespace-pre-wrap pl-4 border-l-2"
        ...
        {editable ? (
          <InlineEditableList
            ...
            defaultItem={{
              ...
              content: "Go Programming Language Certification\nCloud Native Go Development\nMicroservices with Go",
              id: Date.now().toString(),
            }}
