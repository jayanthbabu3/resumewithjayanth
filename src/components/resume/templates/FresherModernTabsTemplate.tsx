...
interface FresherModernTabsTemplateProps {
...
export const FresherModernTabsTemplate = ({
  resumeData,
  themeColor = "#10b981",
  editable = false,
}: FresherModernTabsTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-gray-50 text-gray-900 p-12">
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-6">
          <div className="inline-block px-5 py-2 rounded-t-lg text-white font-bold text-[14px] uppercase tracking-wider" style={{ backgroundColor: accent }}>
            Profile
          </div>
          <div className="bg-white p-5 rounded-b-lg rounded-tr-lg shadow-sm">
            <InlineEditableText
