...
interface NpmPackageAuthorTemplateProps {
...
export const NpmPackageAuthorTemplate = ({
  resumeData,
  themeColor = "#cb3837",
  editable = false,
}: NpmPackageAuthorTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#cb3837";
  const accentLight = withOpacity(accent, "15") ?? "#cb383715";
  const accentBorder = withOpacity(accent, "33") ?? "#cb383733";
