...
interface FresherDashBorderTemplateProps {
...
export const FresherDashBorderTemplate = ({
  resumeData,
  themeColor = "#10b981",
  editable = false,
}: FresherDashBorderTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#10b981";

  return (
    <div className="w-full h-full bg-white text-gray-900 p-3" style={{ border: `3px dashed ${accent}` }}>
      <div className="p-9">
        {/* Header */}
        <div className="mb-8">
          <InlineEditableText
        ...
        {resumeData.personalInfo.summary && (
          <div className="mb-8 pb-6" style={{ borderBottom: `2px dashed ${withOpacity(accent, "40")}` }}>
