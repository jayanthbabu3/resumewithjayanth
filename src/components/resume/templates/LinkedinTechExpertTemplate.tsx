...
interface LinkedinTechExpertTemplateProps {
...
export const LinkedinTechExpertTemplate = ({
  resumeData,
  themeColor = "#0077b5",
  editable = false,
}: LinkedinTechExpertTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#0077b5";
  const accentLight = withOpacity(accent, "15") ?? "#0077b515";
  const accentBorder = withOpacity(accent, "33") ?? "#0077b533";
