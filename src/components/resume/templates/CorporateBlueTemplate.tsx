  ...
  return (
    <div className="w-full bg-white text-gray-900 p-8 text-[13px] leading-relaxed">
      ...
      <div className="text-center mb-8 pb-6 border-b-4" style={{ borderColor: themeColor }}>
        ...
        {/* Contact Info */}
        <div className="flex justify-center flex-wrap gap-4 text-[12.5px] text-gray-600">
        ...
        <div className="mb-8">
          ...
          {editable ? (
            <InlineEditableSkills
              ...
              renderSkill={(skill) => {
                return skill.name ? (
                  <span className="inline-block mr-4 mb-2 text-[13px] text-gray-700">
                    • {skill.name}
                  </span>
                ) : null;
              }}
            ...
            <div className="flex flex-wrap">
              {resumeData.skills.map((skill) => (
                skill.name ? (
                  <span key={skill.id} className="mr-4 mb-2 text-[13px] text-gray-700">
                    • {skill.name}
                  </span>
                ) : null
              ))}
