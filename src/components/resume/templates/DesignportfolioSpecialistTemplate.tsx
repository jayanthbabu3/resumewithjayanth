...
interface DesignportfolioSpecialistTemplateProps {
...
export const DesignportfolioSpecialistTemplate = ({
  resumeData,
  themeColor = "#ec4899",
  editable = false,
}: DesignportfolioSpecialistTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#ec4899";
  const accentLight = withOpacity(accent, "15") ?? "#ec489915";
  const accentBorder = withOpacity(accent, "33") ?? "#ec489933";
