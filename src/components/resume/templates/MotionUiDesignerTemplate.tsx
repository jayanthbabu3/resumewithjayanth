...
interface MotionUiDesignerTemplateProps {
...
export const MotionUiDesignerTemplate = ({
  resumeData,
  themeColor = "#f97316",
  editable = false,
}: MotionUiDesignerTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#f97316";
  const accentLight = withOpacity(accent, "15") ?? "#f9731615";
  const accentBorder = withOpacity(accent, "33") ?? "#f9731633";
