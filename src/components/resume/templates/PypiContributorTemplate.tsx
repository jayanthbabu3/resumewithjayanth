...
interface PypiContributorTemplateProps {
...
export const PypiContributorTemplate = ({
  resumeData,
  themeColor = "#3775a9",
  editable = false,
}: PypiContributorTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#3775a9";
  const accentLight = withOpacity(accent, "15") ?? "#3775a915";
  const accentBorder = withOpacity(accent, "33") ?? "#3775a933";
