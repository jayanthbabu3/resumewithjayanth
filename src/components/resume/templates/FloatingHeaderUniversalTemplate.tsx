...
interface FloatingHeaderUniversalTemplateProps {
...
export const FloatingHeaderUniversalTemplate = ({
  resumeData,
  themeColor = "# a855f7",
  editable = false,
}: FloatingHeaderUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "# a855f7";
