...
interface CleanModernUniversalTemplateProps {
...
export const CleanModernUniversalTemplate = ({
  resumeData,
  themeColor = "#6d28d9",
  editable = false,
}: CleanModernUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#6d28d9";
