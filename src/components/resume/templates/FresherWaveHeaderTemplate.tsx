...
interface FresherWaveHeaderTemplateProps {
...
export const FresherWaveHeaderTemplate = ({
  resumeData,
  themeColor = "#10b981",
  editable = false,
}: FresherWaveHeaderTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#10b981";

  return (
    <div className="w-full h-full bg-white text-gray-900">
      {/* Wave header */}
      <div className="relative pb-16 mb-8" style={{ backgroundColor: accent }}>
        <div className="p-10 pb-4 text-white">
          ...
          />
          <div className="flex gap-4 text-[13px] flex-wrap opacity-95">
        ...
        {/* Wave SVG */}
        <svg className="absolute bottom-0 w-full" viewBox="0 0 1200 120" preserveAspectRatio="none" style={{ height: "60px" }}>
          <path d="M0,50 C300,100 900,0 1200,50 L1200,120 L0,120 Z" fill="white" />
        </svg>
      </div>
