...
interface CornerAccentUniversalTemplateProps {
...
export const CornerAccentUniversalTemplate = ({
  resumeData,
  themeColor = "#9333ea",
  editable = false,
}: CornerAccentUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#9333ea";
