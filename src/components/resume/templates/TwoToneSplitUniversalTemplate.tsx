...
interface TwoToneSplitUniversalTemplateProps {
...
export const TwoToneSplitUniversalTemplate = ({
  resumeData,
  themeColor = "#15803d",
  editable = false,
}: TwoToneSplitUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#15803d";
