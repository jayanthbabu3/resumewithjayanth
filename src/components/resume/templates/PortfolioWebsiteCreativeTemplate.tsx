...
interface PortfolioWebsiteCreativeTemplateProps {
...
export const PortfolioWebsiteCreativeTemplate = ({
  resumeData,
  themeColor = "#6366f1",
  editable = false,
}: PortfolioWebsiteCreativeTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#6366f1";
  const accentLight = withOpacity(accent, "15") ?? "#6366f115";
  const accentBorder = withOpacity(accent, "33") ?? "#6366f133";
