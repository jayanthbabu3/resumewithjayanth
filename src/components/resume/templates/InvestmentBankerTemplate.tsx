...
interface InvestmentBankerTemplateProps {
...
export const InvestmentBankerTemplate = ({
  resumeData,
  themeColor = "#059669",
  editable = false,
}: InvestmentBankerTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-3 uppercase tracking-wider" style={{ color: accent }}>Professional Profile</h2>
