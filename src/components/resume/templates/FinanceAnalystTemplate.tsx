...
interface FinanceAnalystTemplateProps {
  resumeData: ResumeData;
  themeColor?: string;
  editable?: boolean;
}

export const FinanceAnalystTemplate = ({
  resumeData,
  themeColor = "#1565c0",
  editable = false,
}: FinanceAnalystTemplateProps) => {
  ...
  return (
    <div className="mx-auto bg-white p-12 font-sans text-gray-900">
      ...
      <div className="mb-6">
        ...
        <div className="border-t-2 pt-2 text-sm text-gray-600" style={{ borderColor: themeColor }}>
          {editable ? (
            <>
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-6">
          ...
          <div className="h-px mb-3 bg-gray-300" />
          {editable ? (
            <InlineEditableText
          ...
          {editable ? (
            <InlineEditableList
              ...
              defaultItem={{
                ...
                startDate: "2023-01",
                endDate: "2024-01",
                description: "Performed financial modeling and forecasting for $X million portfolio\nAnalyzed financial data to identify cost savings opportunities totaling $X\nPrepared quarterly variance analysis and executive presentations\nCollaborated with cross-functional teams to optimize budget allocation",
                current: false,
              }}
