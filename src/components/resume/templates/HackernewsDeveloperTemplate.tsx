...
interface HackernewsDeveloperTemplateProps {
...
export const HackernewsDeveloperTemplate = ({
  resumeData,
  themeColor = "#ff6600",
  editable = false,
}: HackernewsDeveloperTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#ff6600";
  const accentLight = withOpacity(accent, "15") ?? "#ff660015";
  const accentBorder = withOpacity(accent, "33") ?? "#ff660033";
