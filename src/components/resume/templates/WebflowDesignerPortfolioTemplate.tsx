...
interface WebflowDesignerPortfolioTemplateProps {
...
export const WebflowDesignerPortfolioTemplate = ({
  resumeData,
  themeColor = "#4353ff",
  editable = false,
}: WebflowDesignerPortfolioTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#4353ff";
  const accentLight = withOpacity(accent, "15") ?? "#4353ff15";
  const accentBorder = withOpacity(accent, "33") ?? "#4353ff33";
