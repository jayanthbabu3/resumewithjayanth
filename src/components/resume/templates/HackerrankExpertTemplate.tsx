...
interface HackerrankExpertTemplateProps {
...
export const HackerrankExpertTemplate = ({
  resumeData,
  themeColor = "#00ea64",
  editable = false,
}: HackerrankExpertTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#00ea64";
  const accentLight = withOpacity(accent, "15") ?? "#00ea6415";
  const accentBorder = withOpacity(accent, "33") ?? "#00ea6433";
