...
interface GithubPortfolioDevTemplateProps {
...
export const GithubPortfolioDevTemplate = ({
  resumeData,
  themeColor = "#24292e",
  editable = false,
}: GithubPortfolioDevTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#24292e";
  const accentLight = withOpacity(accent, "15") ?? "#24292e15";
  const accentBorder = withOpacity(accent, "33") ?? "#24292e33";
