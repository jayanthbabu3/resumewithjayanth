...
interface SubstackAuthorTemplateProps {
...
export const SubstackAuthorTemplate = ({
  resumeData,
  themeColor = "#ff6719",
  editable = false,
}: SubstackAuthorTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#ff6719";
  const accentLight = withOpacity(accent, "15") ?? "#ff671915";
  const accentBorder = withOpacity(accent, "33") ?? "#ff671933";
