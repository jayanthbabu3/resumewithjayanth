...
interface DockerhubPublisherTemplateProps {
...
export const DockerhubPublisherTemplate = ({
  resumeData,
  themeColor = "#2496ed",
  editable = false,
}: DockerhubPublisherTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#2496ed";
  const accentLight = withOpacity(accent, "15") ?? "#2496ed15";
  const accentBorder = withOpacity(accent, "33") ?? "#2496ed33";
