...
interface DeviantartArtistTemplateProps {
...
export const DeviantartArtistTemplate = ({
  resumeData,
  themeColor = "#05cc47",
  editable = false,
}: DeviantartArtistTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#05cc47";
  const accentLight = withOpacity(accent, "15") ?? "#05cc4715";
  const accentBorder = withOpacity(accent, "33") ?? "#05cc4733";
