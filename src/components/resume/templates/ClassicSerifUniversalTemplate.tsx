...
interface ClassicSerifUniversalTemplateProps {
...
export const ClassicSerifUniversalTemplate = ({
  resumeData,
  themeColor = "#7c2d12",
  editable = false,
}: ClassicSerifUniversalTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#7c2d12";
