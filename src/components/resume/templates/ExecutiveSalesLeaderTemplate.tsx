...
interface ExecutiveSalesLeaderTemplateProps {
...
export const ExecutiveSalesLeaderTemplate = ({
  resumeData,
  themeColor = "#f97316",
  editable = false,
}: ExecutiveSalesLeaderTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-3 uppercase tracking-wider" style={{ color: accent }}>Professional Summary</h2>
      ...
      {resumeData.skills && resumeData.skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Core Skills</h2>
