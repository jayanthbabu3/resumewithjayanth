...
interface StackoverflowDevTemplateProps {
...
export const StackoverflowDevTemplate = ({
  resumeData,
  themeColor = "#f48024",
  editable = false,
}: StackoverflowDevTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#f48024";
  const accentLight = withOpacity(accent, "15") ?? "#f4802415";
  const accentBorder = withOpacity(accent, "33") ?? "#f4802433";
