...
interface InstagramCreativeTemplateProps {
...
export const InstagramCreativeTemplate = ({
  resumeData,
  themeColor = "#e4405f",
  editable = false,
}: InstagramCreativeTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#e4405f";
  const accentLight = withOpacity(accent, "15") ?? "#e4405f15";
  const accentBorder = withOpacity(accent, "33") ?? "#e4405f33";
