...
interface FresherTopBottomTemplateProps {
...
export const FresherTopBottomTemplate = ({
  resumeData,
  themeColor = "#10b981",
  editable = false,
}: FresherTopBottomTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#10b981";

  return (
    <div className="w-full h-full bg-white text-gray-900">
      {/* Top accent bar */}
      <div className="h-3" style={{ backgroundColor: accent }}></div>
