...
interface SalesMarketingHybridTemplateProps {
  resumeData: ResumeData;
  themeColor?: string;
  editable?: boolean;
}

export const SalesMarketingHybridTemplate = ({
  resumeData,
  themeColor = "#ff6f00",
  editable = false,
}: SalesMarketingHybridTemplateProps) => {
          ...
          {editable ? (
            <InlineEditableList
              ...
              defaultItem={{
                ...
                position: "Sales POSITION_TYPE Marketing Position",
                startDate: "2023-01",
                endDate: "2024-01",
