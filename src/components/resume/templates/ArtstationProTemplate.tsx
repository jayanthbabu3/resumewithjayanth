...
interface ArtstationProTemplateProps {
...
export const ArtstationProTemplate = ({
  resumeData,
  themeColor = "#13aff0",
  editable = false,
}: ArtstationProTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#13aff0";
  const accentLight = withOpacity(accent, "15") ?? "#13aff015";
  const accentBorder = withOpacity(accent, "33") ?? "#13aff033";
