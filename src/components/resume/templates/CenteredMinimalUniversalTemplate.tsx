...
interface CenteredMinimalUniversalTemplateProps {
...
export const CenteredMinimalUniversalTemplate = ({
  resumeData,
  themeColor = "#0f172a",
  editable = false,
}: CenteredMinimalUniversalTemplateProps) => {
    ...
    <div className="w-full h-full bg-white text-gray-900 p-16 text-[13px] leading-relaxed">
        ...
        {editable ? (
          <>
            <InlineEditableText
              ...
              className="text-[36px] font-light mb-3 block"
              style={{ color: accent }}
              as="h1"
            />
            <InlineEditableText
          ...
          <>
            <h1 className="text-[36px] font-light mb-3" style={{ color: accent }}>
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-12 max-w-3xl mx-auto">
          <div className="w-12 h-0.5 mx-auto mb-4" style={{ backgroundColor: accent }}></div>
          {editable ? (
            <InlineEditableText
              path="personalInfo.summary"
              value={resumeData.personalInfo.summary}
              className="text-[13px] text-gray-700 leading-[1.8] block text-center"
              multiline
              as="p"
            />
          ) : (
      ...
      {resumeData.experience && resumeData.experience.length > 0 && (
        <div className="mb-12 max-w-4xl mx-auto">
          <div className="text-center mb-6">
            <h2 className="text-[13px] font-semibold uppercase tracking-widest inline-block pb-1 border-b-2" style={{ color: accent, borderColor: accent }}>
              Experience
            </h2>
          </div>
          {editable ? (
              ...
              return (
                <div key={index} className="mb-8 last:mb-0">
                  ...
                  {bulletPoints.length > 0 && (
                    <ul className="ml-5 list-disc space-y-1 text-[12.5px] text-gray-700 leading-[1.7] text-left">
          ...
          {editable ? (
            <InlineEditableList
              ...
              renderItem={(edu, index) => (
                <div className="mb-4 last:mb-0 text-center">
                  <InlineEditableText
          ...
          {editable ? (
            <div className="text-center">
              <InlineEditableSkills
                ...
                renderSkill={(skill) => (
                  <span className="text-[13px] text-gray-900 mx-3">
                    {skill.name}
                  </span>
                )}
              />
            ...
            <div className="text-center">
              {resumeData.skills.map((skill, index) => (
                <span key={index} className="text-[13px] text-gray-900 mx-3">
                  {skill.name}
      ...
      {resumeData.sections && resumeData.sections.length > 0 && (
        editable ? (
              ...
              <div className="mb-12 max-w-4xl mx-auto">
                <div className="text-center mb-6">
                  <InlineEditableText
                    ...
                    value={section.title}
                    className="text-[13px] font-semibold uppercase tracking-widest inline-block pb-1 border-b-2"
          ...
          resumeData.sections.map((section, sectionIndex) => (
            <div key={sectionIndex} className="mb-12 max-w-4xl mx-auto">
              <div className="text-center mb-6">
                <h2 className="text-[13px] font-semibold uppercase tracking-widest inline-block pb-1 border-b-2" style={{ color: accent, borderColor: accent }}>
                  {section.title}
                </h2>
              </div>
              <div className="text-[13px] text-gray-700 leading-[1.8] text-center">
