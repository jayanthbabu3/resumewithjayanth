...
interface MedicalCertificationTemplateProps {
...
export const MedicalCertificationTemplate = ({
  resumeData,
  themeColor = "#ef4444",
  editable = false,
}: MedicalCertificationTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#ef4444";
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      ...
      {resumeData.experience && resumeData.experience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Clinical Experience</h2>
      ...
      {resumeData.education && resumeData.education.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Education & Certifications</h2>
      ...
      {resumeData.skills && resumeData.skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Clinical Skills & Competencies</h2>
