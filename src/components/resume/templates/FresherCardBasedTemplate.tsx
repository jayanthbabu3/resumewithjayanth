...
import { Mail, Phone, MapPin, Calendar, GraduationCap, Briefcase, Code } from "lucide-react";
...
interface FresherCardBasedTemplateProps {
  resumeData: ResumeData;
  themeColor?: string;
  editable?: boolean;
}

export const FresherCardBasedTemplate = ({
  resumeData,
  themeColor = "#14B8A6",
  editable = false,
}: FresherCardBasedTemplateProps) => {
    ...
    <div className="w-full h-full bg-gray-100 overflow-auto">
      <div className="max-w-[850px] mx-auto p-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
            ...
            <div className="flex-1">
              {editable ? (
                <InlineEditableText
                  ...
                  className="text-3xl font-bold text-gray-900 tracking-tight block mb-2"
                  as="h1"
                />
              ) : (
          ...
          {/* Professional Summary in Header Card */}
        ...
        {/* Custom Sections as Cards - Most Important for Freshers */}
                ...
                renderItem={(section, index) => (
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    <InlineEditableText
                      ...
                      value={section.title}
                      className="text-base font-bold text-gray-900 uppercase tracking-wide mb-4 inline-block"
                      as="h2"
                    />
                    <InlineEditableText
        ...
        <div className="grid grid-cols-2 gap-6">
              ...
              {editable ? (
                <InlineEditableList
                  ...
                  renderItem={(edu, index) => (
                    <div className="mb-4 pb-4 border-b border-gray-200 last:border-0 last:pb-0">
                      <InlineEditableText
          ...
          {/* Internship Experience Card - Optional for Freshers */}
