...
interface FramerDesignerPortfolioTemplateProps {
...
export const FramerDesignerPortfolioTemplate = ({
  resumeData,
  themeColor = "#0055ff",
  editable = false,
}: FramerDesignerPortfolioTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#0055ff";
  const accentLight = withOpacity(accent, "15") ?? "#0055ff15";
  const accentBorder = withOpacity(accent, "33") ?? "#0055ff33";
