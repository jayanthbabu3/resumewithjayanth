...
interface ProfessionalHeaderBannerTemplateProps {
...
export const ProfessionalHeaderBannerTemplate = ({
  resumeData,
  themeColor = "#3b82f6",
  editable = false,
}: ProfessionalHeaderBannerTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      <div className="mb-8 pb-6 border-b-2" style={{ borderColor: accent }}>
        ...
        <InlineEditableText text={resumeData.personalInfo.title} className="text-[16px] text-gray-700 mb-4 font-medium tracking-wide" editable={editable} field="resumeData.personalInfo.title" />
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-3 uppercase tracking-wider" style={{ color: accent }}>Professional Summary</h2>
      ...
      {resumeData.experience && resumeData.experience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Professional Experience</h2>
      ...
      {resumeData.skills && resumeData.skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Skills & Competencies</h2>
