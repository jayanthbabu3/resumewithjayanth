          ...
          {personalInfo.title && (
            <div>
              {editable ? (
                ...
                <p className="text-sm opacity-90">{personalInfo.title}</p>
              )}
            </div>
          )}
        </div>
          ...
          {personalInfo.email && (
            <div className="flex items-start gap-2">
              ...
              {editable ? (
                ...
                <div className="flex-1 break-words">{personalInfo.email}</div>
              )}
            </div>
          )}
          {personalInfo.phone && (
            <div className="flex items-start gap-2">
              ...
              {editable ? (
                ...
                <div className="flex-1">{personalInfo.phone}</div>
              )}
            </div>
          )}
          {personalInfo.location && (
            <div className="flex items-start gap-2">
              ...
              {editable ? (
                ...
                <div className="flex-1">{personalInfo.location}</div>
              )}
            </div>
          )}
        </div>
