...
interface FigmaDesignerPortfolioTemplateProps {
...
export const FigmaDesignerPortfolioTemplate = ({
  resumeData,
  themeColor = "#f24e1e",
  editable = false,
}: FigmaDesignerPortfolioTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#f24e1e";
  const accentLight = withOpacity(accent, "15") ?? "#f24e1e15";
  const accentBorder = withOpacity(accent, "33") ?? "#f24e1e33";
