...
interface GitlabDeveloperTemplateProps {
...
export const GitlabDeveloperTemplate = ({
  resumeData,
  themeColor = "#fc6d26",
  editable = false,
}: GitlabDeveloperTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#fc6d26";
  const accentLight = withOpacity(accent, "15") ?? "#fc6d2615";
  const accentBorder = withOpacity(accent, "33") ?? "#fc6d2633";
