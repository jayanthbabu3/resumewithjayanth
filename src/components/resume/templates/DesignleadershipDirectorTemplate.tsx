...
interface DesignleadershipDirectorTemplateProps {
...
export const DesignleadershipDirectorTemplate = ({
  resumeData,
  themeColor = "#0f766e",
  editable = false,
}: DesignleadershipDirectorTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#0f766e";
  const accentLight = withOpacity(accent, "15") ?? "#0f766e15";
  const accentBorder = withOpacity(accent, "33") ?? "#0f766e33";
