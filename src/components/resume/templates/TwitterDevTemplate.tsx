...
interface TwitterDevTemplateProps {
...
export const TwitterDevTemplate = ({
  resumeData,
  themeColor = "#1da1f2",
  editable = false,
}: TwitterDevTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#1da1f2";
  const accentLight = withOpacity(accent, "15") ?? "#1da1f215";
  const accentBorder = withOpacity(accent, "33") ?? "#1da1f233";
