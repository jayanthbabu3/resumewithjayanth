...
export const LeadFrontendEngineerTemplate = ({ resumeData, themeColor = "#0ea5e9", editable = false }: TemplateProps) => {
  const photo = resumeData.personalInfo.photo;
  const accent = normalizeHex(themeColor) ?? "#0ea5e9";
  ...
  return (
    <div className="w-full min-h-[297mm] bg-white font-['Inter',sans-serif] text-gray-900">
      {/* Header Section - Modern frontend design */}
      <div className="relative bg-gradient-to-br from-white via-blue-50/30 to-white">
        <div className="max-w-4xl mx-auto px-12 pt-12 pb-10">
          <div className="flex items-start justify-between gap-8">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg mb-4 border-2" style={{ borderColor: accent, backgroundColor: accentLight }}>
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: accent }}></div>
                <span className="text-[11px] font-bold uppercase tracking-wider" style={{ color: accent }}>Lead Frontend Engineer</span>
              </div>
              ...
              <p className="text-[15px] font-semibold mb-5" style={{ color: accent }}>
                {editable ? (
                  <InlineEditableText
                    ...
                    placeholder="UI Architecture Lead | Design Systems Expert"
                    as="span"
                  />
                ) : (
        ...
        <div className="h-1" style={{ background: `linear-gradient(to right, ${accent}, ${withOpacity(accent, "50")})` }}></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-12 py-10">
        ...
        {(resumeData.personalInfo.summary || editable) && (
          <div className="mb-10">
            ...
            <p className="text-[13.5px] text-gray-700 leading-[1.8] pl-13">
              {editable ? (
                <InlineEditableText
                  path="personalInfo.summary"
                  value={resumeData.personalInfo.summary || ""}
                  placeholder="Lead Frontend Engineer with 10+ years architecting responsive, accessible UI solutions. Expert in React, TypeScript, and design systems. Led frontend teams in building high-performance web applications, improving Core Web Vitals by 60%, and establishing engineering best practices..."
                  multiline
                  as="span"
                />
              ) : (
        ...
        {((resumeData.skills && resumeData.skills.length > 0) || editable) && (
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 gap-3 pl-13">
              {editable ? (
              ...
              {editable ? (
                <InlineEditableList
                  ...
                  defaultItem={{
                    ...
                    current: false,
                    description: "• Led design system development serving 100+ engineers across 20 products\n• Improved page load performance by 70% through optimization strategies\n• Mentored team of 8 frontend developers in React best practices",
                    id: Date.now().toString(),
                  }}
                  renderItem={(exp, index) => (
                    <div className="relative">
                      <div className="absolute -left-16 top-1 w-3 h-3 rounded-full border-4 border-white shadow-md" style={{ backgroundColor: accent }}></div>
                      <div className="flex justify-between items-start mb-2.5">
                        <div className="flex-1">
                          <h3 className="text-[15px] font-bold text-gray-900">
                            <InlineEditableText
                              ...
                              value={exp.position}
                              placeholder="Lead Position Title"
                              as="span"
                            />
                          </h3>
                        ...
                        <div className="text-[11.5px] text-gray-600 font-semibold whitespace-nowrap ml-4 bg-gray-100 px-3 py-1.5 rounded-md">
                          <InlineEditableDate
          ...
          <InlineEditableList
            ...
            renderItem={(section, index) => (
              <div className="mb-10">
                ...
                <div className="text-[13px] text-gray-700 leading-[1.8] whitespace-pre-wrap pl-13">
                  <InlineEditableText
