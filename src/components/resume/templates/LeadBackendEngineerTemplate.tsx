...
export const LeadBackendEngineerTemplate = ({ resumeData, themeColor = "#16a34a", editable = false }: TemplateProps) => {
  const photo = resumeData.personalInfo.photo;
  const accent = normalizeHex(themeColor) ?? "#16a34a";
  ...
  return (
    <div className="w-full min-h-[297mm] bg-white font-['Inter',sans-serif] text-gray-900">
      {/* Header Section - Clean leadership design */}
      <div className="bg-white border-b-4" style={{ borderColor: accent }}>
          ...
          <div className="flex items-start gap-8">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-[11px] font-bold uppercase tracking-wider text-gray-600">Technical Leadership</span>
              </div>
              <h1 className="text-[40px] font-bold tracking-tight text-gray-900 mb-2">
                {editable ? (
                  <InlineEditableText
              ...
              <p className="text-[16px] font-bold mb-5" style={{ color: accent }}>
                {editable ? (
                  <InlineEditableText
                    ...
                    placeholder="Lead Backend Engineer | API Architect"
                    as="span"
                  />
                ) : (
        ...
        {(resumeData.personalInfo.summary || editable) && (
          <div className="mb-10">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-1 h-20 rounded-full mt-1" style={{ backgroundColor: accent }}></div>
              <div className="flex-1">
                <h2 className="text-[15px] font-bold mb-3 text-gray-900 uppercase tracking-wider">
                  Leadership Profile
                </h2>
                <p className="text-[13.5px] text-gray-700 leading-[1.8]">
                  {editable ? (
                    <InlineEditableText
                      ...
                      placeholder="Lead Backend Engineer with 12+ years designing scalable API architectures and microservices. Expert in leading engineering teams, driving technical excellence, and delivering high-performance solutions. Proven track record in system design, code review, and mentoring developers..."
                      multiline
                      as="span"
                    />
                  ) : (
              ...
              {editable ? (
                ...
                <div className="grid grid-cols-3 gap-3">
                  {resumeData.skills.map((skill, index) => (
                    <div
                      key={index}
                      className="px-4 py-2.5 text-[12.5px] font-medium rounded-lg border-l-4"
                      style={{
            ...
            {editable ? (
              <InlineEditableList
                ...
                defaultItem={{
                  ...
                  current: false,
                  description: "• Architected RESTful API platform serving 50M+ requests daily with 99.99% uptime\n• Led team of 10 engineers in microservices migration, reducing latency by 65%\n• Implemented GraphQL API layer improving client performance by 40%",
                  id: Date.now().toString(),
                }}
                renderItem={(exp, index) => (
                  <div className="mb-8 last:mb-0">
                    <div className="flex items-start gap-4">
                      <div className="w-3 h-3 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: accent }}></div>
                      <div className="flex-1">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="text-[12px] font-semibold whitespace-nowrap ml-4 px-3 py-1.5 rounded-full" style={{ backgroundColor: accentLight, color: accent }}>
                            <InlineEditableDate
