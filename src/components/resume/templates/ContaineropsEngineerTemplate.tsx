...
interface ContaineropsEngineerTemplateProps {
...
export const ContaineropsEngineerTemplate = ({
  resumeData,
  themeColor = "#0284c7",
  editable = false,
}: ContaineropsEngineerTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#0284c7";
  const accentLight = withOpacity(accent, "15") ?? "#0284c715";
  const accentBorder = withOpacity(accent, "33") ?? "#0284c733";
