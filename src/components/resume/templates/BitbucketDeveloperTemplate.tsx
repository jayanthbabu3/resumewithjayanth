...
interface BitbucketDeveloperTemplateProps {
...
export const BitbucketDeveloperTemplate = ({
  resumeData,
  themeColor = "#0052cc",
  editable = false,
}: BitbucketDeveloperTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#0052cc";
  const accentLight = withOpacity(accent, "15") ?? "#0052cc15";
  const accentBorder = withOpacity(accent, "33") ?? "#0052cc33";
