...
interface TensorFlowMLEngineerTemplateProps {
...
export const TensorFlowMLEngineerTemplate = ({
  resumeData,
  themeColor = "#3b82f6",
  editable = false,
}: TensorFlowMLEngineerTemplateProps) => {
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-3 uppercase tracking-wider" style={{ color: accent }}>Technical Summary</h2>
      ...
      {resumeData.skills && resumeData.skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[17px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Core Technical Skills</h2>
