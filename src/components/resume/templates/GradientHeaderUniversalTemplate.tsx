  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 text-[13px] leading-relaxed">
      ...
      <div className="p-10 text-white" style={{ background: `linear-gradient(135deg, ${accent} 0%, ${accent}dd 100%)` }}>
        {editable ? (
          <>
            <InlineEditableText path="personalInfo.fullName" value={resumeData.personalInfo.fullName} className="text-[36px] font-bold mb-2 block text-white" as="h1" />
          ...
          <>
            <h1 className="text-[36px] font-bold mb-2">{resumeData.personalInfo.fullName}</h1>
