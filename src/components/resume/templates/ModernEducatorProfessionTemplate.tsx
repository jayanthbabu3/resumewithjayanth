...
interface ModernEducatorProfessionTemplateProps {
...
export const ModernEducatorProfessionTemplate = ({
  resumeData,
  themeColor = "#f59e0b",
  editable = false,
}: ModernEducatorProfessionTemplateProps) => {
  const accent = normalizeHex(themeColor) ?? "#f59e0b";

  return (
    <div className="w-full h-full bg-white text-gray-900 p-12">
      <div className="mb-8 text-center pb-6 border-b-2" style={{ borderColor: accent }}>
      ...
      {resumeData.personalInfo.summary && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-3 uppercase tracking-wider" style={{ color: accent }}>Teaching Philosophy</h2>
      ...
      {resumeData.experience && resumeData.experience.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Teaching Experience</h2>
      ...
      {resumeData.education && resumeData.education.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Education & Credentials</h2>
      ...
      {resumeData.skills && resumeData.skills.length > 0 && (
        <div className="mb-8">
          <h2 className="text-[16px] font-bold mb-4 uppercase tracking-wider" style={{ color: accent }}>Skills & Expertise</h2>
