...
interface PDFHackernewsDeveloperTemplateProps {
...
export const PDFHackernewsDeveloperTemplate = ({
  resumeData,
  themeColor = "#ff6600",
}: PDFHackernewsDeveloperTemplateProps) => {
