...
interface PDFTimelineVerticalUniversalTemplateProps {
...
export const PDFTimelineVerticalUniversalTemplate = ({
  resumeData,
  themeColor = "#7c3aed",
}: PDFTimelineVerticalUniversalTemplateProps) => {
