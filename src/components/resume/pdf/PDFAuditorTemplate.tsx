...
interface PDFAuditorTemplateProps {
...
const createStyles = (themeColor: string) => StyleSheet.create({
  ...
  skillChip: {
    ...
    paddingVertical: 6,
    borderRadius: 4,
    border: "1.5px solid #28359333",
    backgroundColor: "#28359315",
  },
  skillText: {
    fontSize: 9.5,
    fontWeight: 500,
...
export const PDFAuditorTemplate = ({
  resumeData,
  themeColor = "#283593",
}: PDFAuditorTemplateProps) => {
