...
interface PDFSpecialEducationTeacherTemplateProps {
...
export const PDFSpecialEducationTeacherTemplate = ({
  resumeData,
  themeColor = "#fb923c",
}: PDFSpecialEducationTeacherTemplateProps) => {
