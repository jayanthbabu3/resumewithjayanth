...
interface PDFNutritionistDietitianTemplateProps {
...
export const PDFNutritionistDietitianTemplate = ({
  resumeData,
  themeColor = "#10b981",
}: PDFNutritionistDietitianTemplateProps) => {
