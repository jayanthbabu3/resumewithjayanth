...
interface PDFCleanModernUniversalTemplateProps {
...
export const PDFCleanModernUniversalTemplate = ({
  resumeData,
  themeColor = "#6d28d9",
}: PDFCleanModernUniversalTemplateProps) => {
