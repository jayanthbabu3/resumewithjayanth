...
interface PDFMachineLearningEngineerTemplateProps {
...
export const PDFMachineLearningEngineerTemplate = ({
  resumeData,
  themeColor = "#FF6F00",
}: PDFMachineLearningEngineerTemplateProps) => {
