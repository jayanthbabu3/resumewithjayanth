...
interface PDFKaggleDataScientistTemplateProps {
...
const createStyles = (themeColor: string) => StyleSheet.create({
  ...
  skillChip: {
    ...
    paddingVertical: 6,
    borderRadius: 4,
    border: "1.5px solid #20beff33",
    backgroundColor: "#20beff15",
  },
  skillText: {
    fontSize: 9.5,
    fontWeight: 500,
...
export const PDFKaggleDataScientistTemplate = ({
  resumeData,
  themeColor = "#20beff",
}: PDFKaggleDataScientistTemplateProps) => {
