...
interface PDFStrategicExecutiveProps {
...
const createStyles = (themeColor: string) => StyleSheet.create({
  ...
  sectionTitle: {
    ...
    letterSpacing: 1.2,
    borderBottom: "1.5px solid #1a365d33",
    paddingBottom: 8,
  },
  summary: {
    fontSize: 10.5,
  ...
  skillChip: {
    ...
    paddingVertical: 6,
    borderRadius: 4,
    border: "1.5px solid #1a365d33",
    backgroundColor: "#1a365d15",
  },
  skillText: {
    fontSize: 9.5,
    fontWeight: 500,
...
export const PDFStrategicExecutive = ({
  resumeData,
  themeColor = "#1a365d",
}: PDFStrategicExecutiveProps) => {
