...
interface PDFDataEngineerTemplateProps {
...
export const PDFDataEngineerTemplate = ({
  resumeData,
  themeColor = "#00758F",
}: PDFDataEngineerTemplateProps) => {
