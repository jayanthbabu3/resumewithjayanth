...
interface PDFExecutiveChefTemplateProps {
...
export const PDFExecutiveChefTemplate = ({
  resumeData,
  themeColor = "#92400e",
}: PDFExecutiveChefTemplateProps) => {
