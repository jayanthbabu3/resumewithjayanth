...
interface PDFPrivateTutorSpecialistTemplateProps {
...
export const PDFPrivateTutorSpecialistTemplate = ({
  resumeData,
  themeColor = "#78350f",
}: PDFPrivateTutorSpecialistTemplateProps) => {
