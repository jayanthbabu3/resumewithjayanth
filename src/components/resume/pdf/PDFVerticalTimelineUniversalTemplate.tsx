...
interface PDFVerticalTimelineUniversalTemplateProps {
...
export const PDFVerticalTimelineUniversalTemplate = ({
  resumeData,
  themeColor = "#059669",
}: PDFVerticalTimelineUniversalTemplateProps) => {
