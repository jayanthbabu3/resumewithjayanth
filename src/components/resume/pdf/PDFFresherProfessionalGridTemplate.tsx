...
interface PDFFresherProfessionalGridTemplateProps {
...
export const PDFFresherProfessionalGridTemplate = ({
  resumeData,
  themeColor = "#0d9488",
}: PDFFresherProfessionalGridTemplateProps) => {
