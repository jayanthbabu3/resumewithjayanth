...
interface PDFDigitalMarketingSpecialistTemplateProps {
...
export const PDFDigitalMarketingSpecialistTemplate = ({
  resumeData,
  themeColor = "#f97316",
}: PDFDigitalMarketingSpecialistTemplateProps) => {
