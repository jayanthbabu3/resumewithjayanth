...
interface PDFLinkedInReadyGraduateTemplateProps {
...
export const PDFLinkedInReadyGraduateTemplate = ({
  resumeData,
  themeColor = "#0a66c2",
}: PDFLinkedInReadyGraduateTemplateProps) => {
