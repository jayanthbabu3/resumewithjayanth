...
interface PDFTimelineEleganceProps {
...
const createStyles = (themeColor: string) => StyleSheet.create({
  ...
  sectionTitle: {
    ...
    letterSpacing: 1.2,
    borderBottom: "1.5px solid #2c3e5033",
    paddingBottom: 8,
  },
  summary: {
    fontSize: 10.5,
...
export const PDFTimelineElegance = ({
  resumeData,
  themeColor = "#2c3e50",
}: PDFTimelineEleganceProps) => {
