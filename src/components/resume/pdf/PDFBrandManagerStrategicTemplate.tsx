...
interface PDFBrandManagerStrategicTemplateProps {
...
export const PDFBrandManagerStrategicTemplate = ({
  resumeData,
  themeColor = "#a855f7",
}: PDFBrandManagerStrategicTemplateProps) => {
