...
interface PDFProfessionalCompactUniversalTemplateProps {
...
export const PDFProfessionalCompactUniversalTemplate = ({
  resumeData,
  themeColor = "#1e40af",
}: PDFProfessionalCompactUniversalTemplateProps) => {
