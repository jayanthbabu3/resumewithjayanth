...
interface PDFMarketingAnalyticsManagerTemplateProps {
...
export const PDFMarketingAnalyticsManagerTemplate = ({
  resumeData,
  themeColor = "#06b6d4",
}: PDFMarketingAnalyticsManagerTemplateProps) => {
