...
interface PDFConstructionProjectManagerTemplateProps {
...
export const PDFConstructionProjectManagerTemplate = ({
  resumeData,
  themeColor = "#78716c",
}: PDFConstructionProjectManagerTemplateProps) => {
