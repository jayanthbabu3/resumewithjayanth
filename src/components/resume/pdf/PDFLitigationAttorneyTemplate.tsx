...
interface PDFLitigationAttorneyTemplateProps {
...
export const PDFLitigationAttorneyTemplate = ({
  resumeData,
  themeColor = "#334155",
}: PDFLitigationAttorneyTemplateProps) => {
