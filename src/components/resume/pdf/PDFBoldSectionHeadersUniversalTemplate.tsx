...
interface PDFBoldSectionHeadersUniversalTemplateProps {
...
export const PDFBoldSectionHeadersUniversalTemplate = ({
  resumeData,
  themeColor = "#b91c1c",
}: PDFBoldSectionHeadersUniversalTemplateProps) => {
