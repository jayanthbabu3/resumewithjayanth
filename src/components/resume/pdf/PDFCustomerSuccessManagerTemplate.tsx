...
interface PDFCustomerSuccessManagerTemplateProps {
...
export const PDFCustomerSuccessManagerTemplate = ({
  resumeData,
  themeColor = "#14b8a6",
}: PDFCustomerSuccessManagerTemplateProps) => {
