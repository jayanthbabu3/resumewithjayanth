...
interface PDFTechBloggerGraduateTemplateProps {
...
export const PDFTechBloggerGraduateTemplate = ({
  resumeData,
  themeColor = "#4f46e5",
}: PDFTechBloggerGraduateTemplateProps) => {
