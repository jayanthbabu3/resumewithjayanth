...
interface PDFMarketingProfessionalTemplateProps {
...
export const PDFMarketingProfessionalTemplate = ({
  resumeData,
  themeColor = "#7b1fa2",
}: PDFMarketingProfessionalTemplateProps) => {
