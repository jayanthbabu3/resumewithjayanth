...
interface PDFProfessionalAscendProps {
...
const createStyles = (themeColor: string) => StyleSheet.create({
  ...
  sectionTitle: {
    ...
    letterSpacing: 1.2,
    borderBottom: "1.5px solid #7c2d1233",
    paddingBottom: 8,
  },
  summary: {
    fontSize: 10.5,
...
export const PDFProfessionalAscend = ({
  resumeData,
  themeColor = "#7c2d12",
}: PDFProfessionalAscendProps) => {
