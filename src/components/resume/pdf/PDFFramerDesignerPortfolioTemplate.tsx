...
interface PDFFramerDesignerPortfolioTemplateProps {
...
export const PDFFramerDesignerPortfolioTemplate = ({
  resumeData,
  themeColor = "#0055ff",
}: PDFFramerDesignerPortfolioTemplateProps) => {
