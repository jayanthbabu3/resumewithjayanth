...
interface PDFFieldSalesSpecialistTemplateProps {
...
export const PDFFieldSalesSpecialistTemplate = ({
  resumeData,
  themeColor = "#e11d48",
}: PDFFieldSalesSpecialistTemplateProps) => {
