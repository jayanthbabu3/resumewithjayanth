import { Document, Page, Text, View, StyleSheet, Svg, Path, Image, Link } from '@react-pdf/renderer';
...
export const AbstractVersionDesignerPDF = ({ resumeData, themeColor }: Props) => {
