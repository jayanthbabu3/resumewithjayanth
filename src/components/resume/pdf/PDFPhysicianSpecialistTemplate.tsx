...
interface PDFPhysicianSpecialistTemplateProps {
...
export const PDFPhysicianSpecialistTemplate = ({
  resumeData,
  themeColor = "#0f766e",
}: PDFPhysicianSpecialistTemplateProps) => {
