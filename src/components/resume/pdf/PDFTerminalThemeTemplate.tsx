...
interface PDFTerminalThemeTemplateProps {
...
export const PDFTerminalThemeTemplate = ({
  resumeData,
  themeColor = "#00ff00",
}: PDFTerminalThemeTemplateProps) => {
