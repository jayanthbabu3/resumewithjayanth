...
interface PDFLearningDevelopmentManagerTemplateProps {
...
export const PDFLearningDevelopmentManagerTemplate = ({
  resumeData,
  themeColor = "#f43f5e",
}: PDFLearningDevelopmentManagerTemplateProps) => {
