/**
 * Fresher Classic Template Component
 */
...
const FresherClassicContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const FresherClassicTemplate: React.FC<TemplateComponentProps> = (props) => (
  <BaseTemplateProvider {...props}>
    <FresherClassicContent {...props} />
  </BaseTemplateProvider>
);
