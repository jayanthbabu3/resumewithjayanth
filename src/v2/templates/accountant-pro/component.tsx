/**
 * Accountant Pro Template Component
 */
...
const AccountantProContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const AccountantProTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <AccountantProContent {...props} />
    </BaseTemplateProvider>
  );
};
