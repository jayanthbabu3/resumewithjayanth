/**
 * Bold Headline Template Component
 */
...
const BoldHeadlineContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const BoldHeadlineTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <BoldHeadlineContent {...props} />
    </BaseTemplateProvider>
  );
};
