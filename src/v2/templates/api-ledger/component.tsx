...
const ApiLedgerContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const ApiLedgerTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <ApiLedgerContent {...props} />
    </BaseTemplateProvider>
  );
};
