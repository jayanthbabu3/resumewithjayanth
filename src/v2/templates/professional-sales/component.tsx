/**
 * Professional Sales Template Component
 * 
 * Clean single-column layout with progress bars for skills and languages.
 */
...
const ProfessionalSalesContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const ProfessionalSalesTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <ProfessionalSalesContent {...props} />
    </BaseTemplateProvider>
  );
};
