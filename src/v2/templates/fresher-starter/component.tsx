/**
 * Fresher Starter Template Component
 * 
 * Clean single-column layout optimized for fresh graduates.
 */
...
const FresherStarterContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const FresherStarterTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <FresherStarterContent {...props} />
    </BaseTemplateProvider>
  );
};
