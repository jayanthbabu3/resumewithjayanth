/**
 * System Architect Template Component
 *
...
const SystemArchitectContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const SystemArchitectTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <SystemArchitectContent {...props} />
    </BaseTemplateProvider>
  );
};
