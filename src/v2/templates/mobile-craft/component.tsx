/**
 * Mobile Craft Template Component
 *
 * Minimal single-column layout with crisp accents.
 */
...
const MobileCraftContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const MobileCraftTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <MobileCraftContent {...props} />
    </BaseTemplateProvider>
  );
};
