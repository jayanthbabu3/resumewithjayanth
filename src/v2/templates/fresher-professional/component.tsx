/**
 * Fresher Professional Template Component
 */
...
const FresherProfessionalContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const FresherProfessionalTemplate: React.FC<TemplateComponentProps> = (props) => (
  <BaseTemplateProvider {...props}>
    <FresherProfessionalContent {...props} />
  </BaseTemplateProvider>
);
