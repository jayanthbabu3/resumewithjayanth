 ...
 * 
 * Clean single-column layout with minimal styling.
 */
...
const MinimalContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const MinimalTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <MinimalContent {...props} />
    </BaseTemplateProvider>
  );
};
