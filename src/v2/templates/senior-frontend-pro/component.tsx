/**
 * Senior Frontend Pro Template Component
 */
...
const SeniorFrontendProContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const SeniorFrontendProTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <SeniorFrontendProContent {...props} />
    </BaseTemplateProvider>
  );
};
