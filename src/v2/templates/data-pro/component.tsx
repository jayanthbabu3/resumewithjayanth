...
const DataProContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const DataProTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <DataProContent {...props} />
    </BaseTemplateProvider>
  );
};
