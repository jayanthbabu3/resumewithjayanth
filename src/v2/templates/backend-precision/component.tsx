/**
 * Backend Precision Template Component
 *
...
const BackendPrecisionContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const BackendPrecisionTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <BackendPrecisionContent {...props} />
    </BaseTemplateProvider>
  );
};
