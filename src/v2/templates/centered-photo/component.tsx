/**
 * Centered Photo Template Component
 * 
 * Elegant layout with centered photo header.
 */
...
const CenteredPhotoContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const CenteredPhotoTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <CenteredPhotoContent {...props} />
    </BaseTemplateProvider>
  );
};
