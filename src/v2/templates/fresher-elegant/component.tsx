/**
 * Fresher Elegant Template Component
 * 
...
const FresherElegantContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const FresherElegantTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <FresherElegantContent {...props} />
    </BaseTemplateProvider>
  );
};
