...
const CloudOpsContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const CloudOpsTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <CloudOpsContent {...props} />
    </BaseTemplateProvider>
  );
};
